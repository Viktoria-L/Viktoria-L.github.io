...
export const MyProjects = [
    {
        ...
        info: 'Jag har byggt mina vänners hemsida för deras nya eventkoncept. Sidan är live och det går att signa upp för nyhetsbrev, se kommande events och köpa biljetter.',
